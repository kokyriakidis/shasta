...
staticExecutable/CMakeFiles/shastaStaticExecutable.dir/__/srcMain/main.cpp.o: srcMain/main.cpp \
  ...
  src/Assembler.hpp \
  src/Alignment.hpp \
  src/OrientedReadPair.hpp \
  src/ReadId.hpp \
  src/SHASTA_ASSERT.hpp \
  src/shastaTypes.hpp \
  src/cstdint.hpp \
  ...
  src/utility.hpp \
  src/vector.hpp \
  src/AlignmentCandidates.hpp \
  src/MemoryMappedVectorOfVectors.hpp \
  src/MemoryMappedVector.hpp \
  src/touchMemory.hpp \
  src/cstddef.hpp \
  ...
  src/Align6Marker.hpp \
  src/Kmer.hpp \
  src/ShortBaseSequence.hpp \
  src/Base.hpp \
  src/bitReversal.hpp \
  src/IntegerBySize.hpp \
  src/AssemblerOptions.hpp \
  ...
  src/AssemblyGraph2Statistics.hpp \
  src/HttpServer.hpp \
  src/iosfwd.hpp \
  src/invalid.hpp \
  ...
  src/KmerDistributionInfo.hpp \
  src/invalid.hpp \
  src/MappedMemoryOwner.hpp \
  src/Marker.hpp \
  src/Uint.hpp \
  src/MarkerGraph.hpp \
  src/MarkerInterval.hpp \
  src/tuple.hpp \
  src/MultithreadedObject.hpp \
  ...
  src/memory.hpp \
  src/MarkerGraphEdgePairInfo.hpp \
  src/MemoryMappedObject.hpp \
  src/ReadGraph.hpp \
  ...
  src/LongBaseSequence.hpp \
  src/buildId.hpp \
  src/ConfigurationTable.hpp \
  src/Coverage.hpp \
  src/filesystem.hpp \
  src/mode3-Anchor.hpp \
  src/performanceLog.hpp \
  src/fstream.hpp \
  ...
  src/Tee.hpp \
  src/timestamp.hpp \
  src/platformDependent.hpp \
  src/SimpleBayesianConsensusCaller.hpp \
  src/ConsensusCaller.hpp \
